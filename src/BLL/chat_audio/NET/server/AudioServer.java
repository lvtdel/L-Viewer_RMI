package BLL.chat_audio.NET.server;

import BLL.chat_audio.OS.Audio;
...
public class AudioServer {
    ...
    private void InitAudio() {
        ...
        try {
            ...
            System.out.println("LANAudioServerThread Exception: init audio out failed");
        }
        OpenAudioOut();
    }
    ...
    private void OpenAudioOut() {
        try {
            ...
            System.out.println("LANAudioServerThread Exception: open audio out failed");
        }
    }
